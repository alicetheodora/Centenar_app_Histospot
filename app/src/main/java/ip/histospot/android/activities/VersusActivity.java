...
public class VersusActivity extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    public void onResponse(JSONObject response) {
        try {
            ...
            if (pr.has("photo")) {
                byte[] photoBytes = Base64.decode(pr.getString("photo"), Base64.DEFAULT);
